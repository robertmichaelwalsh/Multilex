...
Assembly.LoadFile
(String.Format
("{0}{1}assemblyresolve{1}test{1}asm.dll",
...
Assembly.LoadFile
(String.Format
("{0}{1}assemblyresolve{1}deps{1}test.dll",
Directory.GetCurrentDirectory
(),
Path.DirectorySeparatorChar));
if
(args.Name
==
"TestBase, Version=0.0.0.0, Culture=neutral"
||
args.Name
==
...
Assembly.LoadFile
(String.Format
("{0}{1}assemblyresolve{1}deps{1}TestBase.dll",
Directory.GetCurrentDirectory
(),
Path.DirectorySeparatorChar));
return
