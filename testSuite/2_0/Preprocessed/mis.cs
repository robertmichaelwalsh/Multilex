...
static
String
docroot="/home/dick/mono/install/html";
private
static
Hashtable
mime_types
...
byte[256];
int
count=sock.Receive(buf);
String
req=new
String(Encoding.UTF8.GetChars(buf),
0,
count);
return(req);
}
...
req=String.Concat(docroot,
req.Remove(0,
4));
int
pos=req.IndexOfAny(new
char[]{' '});
if(pos>=0)
{
req=req.Remove(pos,
...
=
"text/plain";
Console.WriteLine("File is "
+
req);
Console.WriteLine("Mime type is "
+
mime_type);
try
{
