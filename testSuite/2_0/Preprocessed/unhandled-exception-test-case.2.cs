...
private
bool
differentConfigurationIsLegacy;
public
bool
DCIL
{
...
private
bool
useDifferentThreadInDifferentApplicationDomain
=
false;
public
bool
...
private
bool
addHandlerToRootApplicationDomain
=
false;
public
bool
...
private
bool
addHandlerToDifferentApplicationDomain
=
false;
public
bool
...
return
AppDomain.CreateDomain("DifferentAppDomain",
null,
ads);
}
public
...
caller);
Console.WriteLine
("Handling exception type {0}",
ex.GetType().Name);
Console.WriteLine
("Message is {0}",
ex.Message);
Console.WriteLine
("IsTerminating is set to {0}",
e.IsTerminating);
}
public
static
