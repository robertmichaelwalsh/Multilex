...
{
Console.WriteLine
("fully open instantiation of TypeBuilder must have GetConstructors working {0}",
e);
return
4;
}
...
{
Console.WriteLine
("fully open instantiation of the TypeBuilder created type must have GetConstructors working {0}",
e);
return
5;
}
