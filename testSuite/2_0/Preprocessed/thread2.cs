...
{
LocalDataStoreSlot
namedslot=Thread.GetNamedDataSlot("data-slot");
...
thr.Name="wobble";
Thread
otherthr=Thread.CurrentThread;
Console.WriteLine("Other subthread is "
+
otherthr.Name);
Thread.SetData(slot,
thr);
Thread
storedthr=(Thread)Thread.GetData(slot);
Console.WriteLine("Stored subthread is "
+
storedthr.Name);
Thread.SetData(namedslot,
thr);
...
Thread.Sleep(10000);
Thread
storedthr2=(Thread)Thread.GetData(slot);
Console.WriteLine("Stored subthread is still "
+
storedthr2.Name);
}
public
...
LocalDataStoreSlot
namedslot=Thread.AllocateNamedDataSlot("data-slot");
Test
test
=
new
...
main.Name="wibble";
Thread
othermain=Thread.CurrentThread;
