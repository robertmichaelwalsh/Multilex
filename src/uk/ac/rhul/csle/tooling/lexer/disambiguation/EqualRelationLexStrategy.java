...
/**
 * This is a strategy that stores lexical disambiguation rules for class 1
 * disambiguation operations
 * 
 * @author Robert Michael Walsh
 *
 */
public class EqualRelationLexStrategy extends LexStrategy {

  /**
   * Constructs a new class 1 disambiguation strategy with the given set of
   ...
   *      HashMap)
   */
  public EqualRelationLexStrategy(String[] tokens, HashMap<String, Integer> tokenIntegerMappings) {
