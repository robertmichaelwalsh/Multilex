...
/**
 * This is a strategy that stores lexical disambiguation rules for class 3
 * disambiguation operations
 * 
 * @author Robert Michael Walsh
 *
 */
public class LeftShortestLexStrategy extends LexStrategy {

  /**
   * Constructs a new class 3 disambiguation strategy with the given set of
   ...
   *      HashMap)
   */
  public LeftShortestLexStrategy(String[] tokens, HashMap<String, Integer> tokenIntegerMappings) {
