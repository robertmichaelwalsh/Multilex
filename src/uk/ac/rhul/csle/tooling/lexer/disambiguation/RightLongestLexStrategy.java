...
/**
 * This is a strategy that stores lexical disambiguation rules for class 2a
 * disambiguation operations
 * 
 * @author Robert Michael Walsh
 *
 */
public class RightLongestLexStrategy extends LexStrategy {

  /**
   * Constructs a new class 2a disambiguation strategy with the given set of
   ...
   *      HashMap)
   */
  public RightLongestLexStrategy(String[] tokens, HashMap<String, Integer> tokenIntegerMappings) {
